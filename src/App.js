    ...
    <>
      <div className="container">
        ...
        <div id="calculator">
          ...
          <button id="divide" onClick={() => buttonPress("/")} className="orange">/</button>
          ...
          <button id="multiply" onClick={() => buttonPress("*")} className="orange">*</button>
          ...
          <button id="subtract" onClick={() => buttonPress("-")} className="orange">-</button>
          ...
          <button id="add" onClick={() => buttonPress("+")} className="orange">+</button>
